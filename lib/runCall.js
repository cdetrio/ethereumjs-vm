...
const log = require('loglevel').getLogger('runCall');
//log.setLevel("trace")
log.setLevel("silent")
...
module.exports = function (opts, cb) {
  ...
  function loadToAccount (done) {
    log.trace('runCall.js loadToAccount...')
    ...
    if (!toAddress) {
      ...
      log.trace('runCall.js loadToAccount calling stateManager.getAccount..')
      ...
      log.trace('runCall.js loadToAccount calling stateManager.cache.get(toAddress)...')
      toAccount = stateManager.cache.get(toAddress)
      log.trace('runCall.js stateManager.cache.get returned toAccount:', toAccount)
      done()
    }
  }
  ...
  function subTxValue () {
    ...
    log.trace('runCall.js subTxValue calling cache.put..')
  ...
  function addTxValue () {
    ...
    log.trace('runCall.js addTxValue calling cache.put..')
